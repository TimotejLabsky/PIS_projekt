...
namespace Pis.Projekt.Business
{
    ...
    {
        public SalesOptimalizationService(IOptimizationNotificationService notificationService,
        ...
        public async Task OptimizeSalesAsync([FromQuery] int weekOffset = 0,
            CancellationToken token = default)
        {
            ...
            var waiter = scope.ServiceProvider.GetRequiredService<WaiterService>();
